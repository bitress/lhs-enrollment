            ...
            <form id="save_subject" autocomplete="off">
                <div class="modal-body text-dark">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="subject_code" id="subject_code" class="form-control" onkeyup="numbersonly(this)" required>
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <form id="update_subject" autocomplete="off">
                <div class="modal-body text-dark">
                    ...
                    <div class="mb-3">
                        <label for="">Subject Code:</label>
                        <input type="text" name="subject_code" id="subject_code_e" class="form-control" onkeyup="numbersonly(this)" required>
                    </div>
                    <div class="mb-3">
                        <label for="">Subject Name:</label>
        ...
        <div class="modal-content">
            ...
            <form id="update_student" autocomplete="off">
                <div class="modal-body text-dark">
                    ...
                    <div class="mb-3">
                        <label for="">Subject Code:</label>
                        <input type="text" name="subject_code" id="subject_code_v" class="form-control" onkeyup="numbersonly(this)" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="">Subject Name:</label>
