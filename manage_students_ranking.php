...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">STUDENT RANKING</h1>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <!-- Select School Year -->
                                    <div class="col-md-3" id="sy_filters">
                                        <label class="text-uppercase font-weight-bolder">SELECT SCHOOL YEAR</label>
                                            <select class="form-control text-capitalize" name="schoolYearFilter" id="schoolYearFilter">
                                                <option disabled selected> --- Select --- </option>
                                                <?php 
                                                    $query = "SELECT * FROM tbl_sy WHERE sy_status=1 ORDER BY sy";
                                    ...
                                    <!-- Select Grade Level -->
                                    <div class="col-md" id="gr_filters" style="display: none;">
                                        <label class="text-uppercase font-weight-bolder">SELECT GRADE LEVEL</label>
                                            <select class="form-control text-capitalize" name="gradeLevelFilter" id="gradeLevelFilter">
                                                <option disabled selected> --- Select --- </option>
                                                <?php 
                                                    $query = "SELECT * FROM tbl_grade_level ORDER BY grade_level_id ASC";
                                                    foreach ($connect->query($query) as $row) {      
                                                ?>
                    ...
                    <div id="spinner" style="display: none;">
                        <div class="spinner-grow spinner-grow-sm text-info ml-2"></div>
                    </div>
                    
                    <div class="mt-4 mb-5" id="display_ranking"></div>
    ...
    <script>
        $('#schoolYearFilter').on('change', function(){
            var schoolyear = $('#schoolYearFilter').find(":selected").val();
            var gradelevel = $('#gradeLevelFilter').find(":selected").val();
            //alert(schoolyear);
            //alert(gradelevel);
              $.ajax({
                  type: "POST",
                  url: 'student_ranking_filter.php',
                  data: {schoolyear: schoolyear, gradelevel: gradelevel},
                  beforeSend: function(){
                    $('#gr_filters').show();
                    $('#display_ranking').hide();
                  },
                  success: function(data){
                    $('#display_ranking').show();
                    $('#display_ranking').html(data);
                  }
              })
        });
