					    ...
					    <tbody>
					        ...
					        <tr class="text-capitalize">
					            ...
					            <td class="text-center">
					                <button type="button" value="<?php echo $row["student_id"] ?>" class="gradingSheetBtn btn btn-info btn-sm"><i class="fas fa-eye me-1"></i> Student Grades </button>
                                </td>
					        </tr>
...
<script type="text/javascript">
    //view student 1
    $(document).on('click', '.gradingSheetBtn', function () {

        var student_id = $(this).val();
        //alert(student_id);  
        $.ajax({
            type: "POST",
            url: "load-subject.php",
    ...
    $(document).on('submit', '#saveStudentGrade', function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "action/code-save_grade.php",
            data: formData,
            processData: false,
            contentType: false,
            success: function (response) {
