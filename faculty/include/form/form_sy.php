...
<div class="modal fade" id="addSYModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="save_sy" autocomplete="off">
                <div class="modal-body text-dark">
                    
                    <div class="mb-3">
                        <label for="">School Year:</label>
                        <input type="text" name="sy" id="sy" class="form-control" onkeyup="numbersonly(this)" required>
                    </div>
...
<!-- Edit Faculty -->
<div class="modal fade" id="editSYModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light text-uppercase" id="exampleModalLabel">
            ...
            <form id="update_sy" autocomplete="off">
                <div class="modal-body text-dark">
                    
                    <input type="hidden" name="sy_id" id="sy_id_e" >

                    <div class="mb-3">
                        <label for="">School Year:</label>
                        <input type="text" name="sy" id="sy_e" class="form-control" onkeyup="numbersonly(this)" required>
                    </div>
